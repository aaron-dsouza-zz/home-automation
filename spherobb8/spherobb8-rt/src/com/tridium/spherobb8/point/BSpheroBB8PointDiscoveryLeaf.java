...
/**
 * BSpheroBB8PointDiscoveryLeaf is container class for point elements to display in 
...
public class BSpheroBB8PointDiscoveryLeaf
...
////////////////////////////////////////////////////////////////
   ...
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#getStatusValue
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#setStatusValue
   */
   ...
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#statusValue
   */
...
////////////////////////////////////////////////////////////////
   ...
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#getFacets
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#setFacets
   */
  public static final Property facets = newProperty(Flags.READONLY, BFacets.DEFAULT,SfUtil.incl(SfUtil.MGR_UNSEEN));
  
  /**
   * Get the <code>facets</code> property.
   * @see com.honeywell.redlink.ui.BSpheroBB8PointDiscoveryLeaf#facets
   */
...
////////////////////////////////////////////////////////////////
  ...
  public static final Type TYPE = Sys.loadType(BSpheroBB8PointDiscoveryLeaf.class);

/*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  
  public BSpheroBB8PointDiscoveryLeaf() {}
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BSpheroBB8ProxyExt pext = new BSpheroBB8ProxyExt();
  ...
  { 
    ...
    BControlPoint cp = (BControlPoint)target;
    BSpheroBB8ProxyExt pext = (BSpheroBB8ProxyExt)cp.getProxyExt();
    //
