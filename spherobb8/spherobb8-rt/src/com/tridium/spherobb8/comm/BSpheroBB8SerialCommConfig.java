...
/**
 * BSpheroBB8SerialCommConfig Handles the serial communication for the driver. 
 *
...
public class BSpheroBB8SerialCommConfig
...
////////////////////////////////////////////////////////////////
  ...
  public static final Type TYPE = Sys.loadType(BSpheroBB8SerialCommConfig.class);

/*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/

  /** Empty constructor  */
  public BSpheroBB8SerialCommConfig() {  }
    ...
    return new NLinkMessageFactory(1024)
      {
        ...
        {
          return new SpheroBB8SerialLinkMessage(1024); 
        }
      };
  }
