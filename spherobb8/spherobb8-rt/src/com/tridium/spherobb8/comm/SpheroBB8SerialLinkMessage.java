...
/**
 * SpheroBB8SerialLinkMessage streams data to and from a byte array representation.
 *
 * @author   Aaron D'souza
 * @creation 24-May-16 
 */
public class SpheroBB8SerialLinkMessage
  extends LinkMessage
{
  public SpheroBB8SerialLinkMessage(int maxLen)  { super(maxLen); }
